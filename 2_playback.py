"""
Some people have a habit of (lecturing) speaking rather quickly, and it would be nice to slow them down, a la YouTubes 0.75 playback speed, 
...
userInput = input("Please what would you like to say? ").replace(" ", "...")
print(userInput)